...
class TransformerBottleneck_(nn.Module):
    def __init__(self, in_channels, num_heads=8, dim_feedforward=1024, num_layers=1):
...
class TransformerBottleneck(nn.Module):
    def __init__(self, in_channels, num_heads=4, dim_feedforward=512, num_layers=3):
        super(TransformerBottleneck, self).__init__()
