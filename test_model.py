...
from model.unet import UNet2,UNet2_Atten,UNet2_Atten_Trans,UNet2_se,UNet2_se_Atten,UNet2_se_Atten_Trans
...
BATCH_SIZE=1
PRETRAINED_MODEL_PATH="./output/output_model/UNet2_Atten_Trans.pth"
...
def main():
    """Define Model"""
    model=UNet2_Atten_Trans(3,4).to(DEVICE)
